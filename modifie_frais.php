...
<!-- Affichage de la bannière -->
	<div class="formulaire"> 
		...
		<table class="form">
			<tr>
				<td>	<!--REDIRIGIRE VERS UNE PAGE QUI ENREGISTRE LES INFORMATIONS SAISIES-->
					<form name="inscription" action="#.php" method ="post" onsubmit="javascript: return verifSaisie();">
					</br></br>
						<fieldset class="separateur"><legend class="legende">Note de frais des bénévoles</legend>
							</br></br></br>
						    <label>Je soussigné(e)</label>
						    </br>
						    <input type="text" placeholder="Nom"   id="email" name="email" maxlength="60" size="110" class="case"/>		
						    </br>
