...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 11 Avril 2019 à 10:46
...
INSERT INTO `adherents` (`NUMERO_LICENCE`, `NUM_ADH`, `SEXE_ADH`, `NOM_ADH`, `PRENOM_ADH`, `DATENAIS_ADH`, `ADRESSE1_ADH`, `CP_ADH`, `VILLE_ADH`) VALUES
('17 05 40 010 443', 0, 'M', 'BANDILELLA', 'CLEMENT', '26/07/1998', '30, rue Widric 1er', 54600, 'Villers lès Nancy'),
('17 05 40 010 340', 1, 'F', 'BERBIER', 'LUCILLE', '24/03/1998', '12, rue de Marron', 54600, 'Villers lès Nancy'),
(' 17 05 40 010 338', 1, 'M', 'BERBIER', 'THEO', '24/03/1998', '12, rue de Marron', 54600, 'Villers lès Nancy'),
(' 17 05 40 010 309', NULL, 'M', 'BECKER', 'ROMAIN', '28/03/1998', '1, rue des Mésanges', 54600, 'Villers lès Nancy'),
('17 05 40 010 334', NULL, 'F', 'BIACQUEL', 'VERONIQUE', '09/12/1962', '27, rue de Santifontaine', 54000, 'Nancy'),
(' 17 05 40 010 399', NULL, 'F', 'BIDELOT', 'BRIGITTE', '20/09/1958', '5, rue des trois épis', 54600, 'Villers lès Nancy'),
('17 05 40 010 442', NULL, 'F', 'BIDELOT', 'JULIE', '30/11/1991', '5, rue des trois épis', 54600, 'Villers lès Nancy'),
('17 05 40 010 308', NULL, 'M', 'BILLOT', 'DIDIER', '24/09/1962', '6, rue de la Sapinière', 54600, 'Villers lès Nancy'),
('17 05 40 010 329', NULL, 'F', 'BILLOT', 'CLAIRE', '07/06/1963', '6, rue de la Sapinière', 54600, 'Villers lès Nancy'),
('17 05 40 010 254', NULL, 'F', 'BILLOT', 'MARIANNE', '28/09/1986', '6, rue de la Sapinière', 54600, 'Villers lès Nancy');
...
CREATE TABLE IF NOT EXISTS `lien` (
  ...
  PRIMARY KEY (`NUMERO_LICENCE`,`MAIL_ADH`),
  KEY `I_FK_LIEN_ADHERENTS` (`NUMERO_LICENCE`),
  KEY `I_FK_LIEN_DEMANDEURS` (`MAIL_ADH`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `lien` (`NUMERO_LICENCE`, `MAIL_ADH`) VALUES
